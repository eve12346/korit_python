...
def process_person(obj):
    if isinstance(obj, Student):
        print(f"{obj.grade}학년 학생입니다.")
    elif isinstance(obj, Teacher):
        print(f"{obj.subject}담당 선생님입니다.")
...
person = Person("곽민성")
student = Student("최유지", 2)
teacher = Teacher("이동윤", "파이썬")

process_person(person)
process_person(student)
process_person(teacher)